...
\end{equation}
Although the detection window was compressed to 11 days ($t_{\text{notice}} \approx 264\text{ hours}$), the high execution velocity ($V_E$) yielded an exponential loss density before containment could be negotiated humanly. This empirically validates \textbf{Axiom 1}: human incident response cannot intercept high-velocity agent cascades without automated step-function containment ($K_{\text{cb}}$).
...
\input{figures/case_study_comparative}
